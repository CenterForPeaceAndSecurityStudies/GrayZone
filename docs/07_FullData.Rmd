...
plot(venneuler::venneuler(coverage_venn))

#VennDiagram::venn.diagram(coverage_venn, category.names = c("cPASS" , "ICB" , "DCID", "REI"), filename = )
...
The new variables for intensity have been coded by hand into the previous spreadsheet. That can be reloaded now to analyze the complete version of the dataset

```{r}
df_complete <- googlesheets::gs_title("Russian wars")
df_complete <- df_complete %>% googlesheets::gs_read("grayzone_aggregate")
