...
vars_id <- c("crisno", "systrgyr", "crisname")
...
icb_actor_rus <- icb_actor_rus[ , c('crisno', 'crisname', 'systrgyr', 'cenvio', 'sevvio', 'viol', 'outesr', 'outcom', 'trgterra', 'geog', 'cractloc', 'noactr')]
...
formattable::formattable(icb_actor_rus,
                         align = c("l", "l", "c", "c", "c", "c", "c", "c", "c", "l", "l", "c"),
