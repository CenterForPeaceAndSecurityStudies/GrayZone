...
# Impute for subsample has to be done separately due to the different n. We remove civilwar because there are less than 5 observations with value 1 which creates unbalanced imputation estimates
...
# Imputed model 6. We remove civil war from here because 
...
We here show models results for the newly imputed model 2:
