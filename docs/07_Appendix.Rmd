...
\end{align*}
Note that based on Assumption 2 (as is written: that $\frac{1}{4\beta_{D}}-\kappa_{D}>0$), the above sign does not flip. I can say that $\zeta\kappa_{C}-\zeta\beta_{C}\left(\rho_{W}-\rho_{0}+\kappa_{D}+\frac{1}{4\beta_{D}}\right)^{2}>\zeta\kappa_{C}-\beta_{C}\left(\rho_{W}-\rho_{0}+\kappa_{D}+\frac{1}{4\beta_{D}}\right)^{2}$. This implies that {\footnotesize{}
\begin{align*}
