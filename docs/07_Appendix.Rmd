...
```{r model df prep}
# Make year dummies and subset to European sample
df <- df_full %>%
...
```{r prenato-results, results = 'asis', eval = FALSE}
# Make list of models
