...
We produce the same model 1 and model 4 results in a separate table below to avoid confusion since those models have no imputed values

```{r non-impute results, results = 'asis', echo = FALSE}
# Prep odds ratio
