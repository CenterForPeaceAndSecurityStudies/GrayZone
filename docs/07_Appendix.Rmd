...
m2_res <- m2_res %>%
  ...
  dplyr::mutate(rowname = dplyr::recode(rowname, 
                ...
                'lnpop1' = "Population",
                "gdppc1_2010const" = "GDP per capita")) %>%
...
### Imputed model 3
This model replicates model 3 in the main text, with control variables imputed:
...
Test alternat model of zero-inflated ordered probit, since 95% of Europe country-years from 1994-2018 experienced no Russian attack.
