...
This document will look at coverage of Russian electoral inference (1991-2017) from Casey and Ahmad (2017) and identify variables of interest.
...
rei$`Target Event` <- plyr::revalue(rei$`Target Event`, c("1" = "National Election",
                                                          "2" = "Referendum",
                                                          "3" = "Political Party Operations"))

rei$Outcome <- as.character(rei$Outcome)
rei$Outcome <- plyr::revalue(rei$Outcome, c("1" = "Incumbent victory",
                                            "2" = "Incumbent loss",
...
formattable::formattable(rei,
                         align = c("c", "l", "c", "c", "c", "c", "c", "c", "c", "c", "c", "c", "l", "c", "c"),
                         list('Pro-incumbent' = formattable::color_tile("red", "red4"),
...
```{r}
ggplot2::ggplot(rei, aes(Type, ..count..)) +
  geom_bar() +
  labs(x = "Cyberattack Type", y = "Count", title = "Russian Cyberattack Types (2008-2011)")
ggplot2::ggsave("electioninterference_type.png", path = paste0(here::here(), '/paper/figures'))

ggplot2::ggplot(dcid_rus, aes(Method, ..count..)) +
  geom_bar() +
  labs(x = "Cyberattack Method", y = "Count", title = "Russian Cyberattacks Methods (2008-2011)")
