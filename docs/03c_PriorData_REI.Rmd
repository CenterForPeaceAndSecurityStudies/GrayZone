...
There is no variable that directly codes the severity of Russian interference to allow for inter-case comparison. We can make a composite index of that by noting the highest level of interference in each case.
