...
ggplot2::ggplot(ipe_theta_plot, aes(x = theta_scaled, y = gdppc_WDI_log_scaled)) + 
  ggrepel::geom_text_repel(data = ipe_theta_plot, aes(label = name), size = 3) + 
  geom_abline(intercept = 0, slope = 1, linetype = 2) +
  labs(title = "GDP per capita-MCTL Correlation (2001)", x = "MCTL Score", y = "GPD per capita (log)", caption = "Axes scaled around mean value")
ggplot2::ggsave("correlation_gdppc.png", path = paste0(here::here(), '/paper/figures'))
