...
ipe$ccode1[ipe$country == "Serbia"] <- 345
ipe$ccode1[ipe$country == "Kosovo"] <- 347
...
## ELF
We take a measure of ethno-linguistic fractionalization (ELF) from the Historical Index of Ethnic Fractionalizatin (HEIF) dataset that covers 1945-2013. The index measures the probability that2 randomly drawn individuals are not from the same ethnic group
```{r}
...
continent$continent[df$cabbrev1 == "YUG" | df$cabbrev1 == "KOS" | df$cabbrev1 == "GRG"] <- "Europe"
