...
# Problems comes from having both civil war and year in the model
...
table(df_conserv$civilwar, df_conserv$year)
...
# Compiled results
```{r}
texreg::screenreg(list(m1, m2, m3, m4, m6))
```
...
plot(rms::nomogram(m3_imp, fun = plogis))
```
