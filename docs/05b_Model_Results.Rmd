...
df_m2 <- df %>%
  dplyr::select(intensity, NATOmem_MEM, lnmindistkm_rus, demo1, nuclear1, lngdppc1_2010const, lnpop1, dplyr::starts_with("year_"))
...
df_m3 <- df %>%
  dplyr::select(intensity, NATOmem_MEM, lnmindistkm_rus, demo1, nuclear1, lngdppc1_2010const, cinc_ratio, dplyr::starts_with("year_"))
...
stargazer2(models, 
           ...
           omit = "year",
           title = "Odds Ratios",
           column.labels   = c("Full sample", "Relevant states sample"),
