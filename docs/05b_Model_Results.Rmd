...
We have to extrapolate variables for post-2012 since that is the last year that data for CINC scores is available.
```{r}
...
With the data imputed, now we can run the model
```{r}
...
## Country-clustered standard errors
rms::robcov(m3, df_imp_long$cabbrev1)
