...
df_vars <- df %>%
  dplyr::select(year, cabbrev1, intensity, NATOmem_MEM, lnmindistkm_rus, gdppc1_2010const, lnpop1, civilwar, demo1, nuclear1, cinc_ratio) %>%
...
ExPanDaR::prepare_missing_values_graph(df_vars, ts_id = "year")
```
